...
public class KostLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "PRINT", "WRITE", "READ", "TRUE", "FALSE", 
			"AND", "OR", "XOR", "NEG", "SIZEOF", "FUNCTION", "ENDIF", "ENDWHILE", 
			"ENDF", "IF", "ELSE", "WHILE", "DO", "STRING", "ID", "REAL", "INT", "ADD", 
			"SUB", "MULT", "DIV", "NEWLINE", "WS"
		};
	}
